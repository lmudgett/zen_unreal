...
// x64 port: these classes are mirrored by UnrealScript declarations, whose
// layout rules match #pragma pack(4) (the generated headers' packing); the
// 1998 build compiled everything /Zp4, so restore that here for the mirrored
// classes.
#pragma pack (push,4)
