...
class ENGINE_API ULevel : public ULevelBase
{
	...
	FLOAT                   TimeSeconds;
	// x64 port: double-precision master clock - FLOAT cannot resolve a 5ms
	// tick once TimeSeconds is a few hours old (game time runs fast, then
	// freezes). Not serialized; ULevel::Tick resyncs it from TimeSeconds.
