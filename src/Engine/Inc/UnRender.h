...
struct ENGINE_API FSceneNode
{
	...
	// x64 port: was an anonymous union aliasing these as discrete FLOATs
	// (Proj_X etc.); the aliases were unused and the union deleted the
	// implicit default constructor under modern C++ rules.
