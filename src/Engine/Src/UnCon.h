...
// x64 port: mirrored by Console.uc — script layout rules match pack(4), the
// 1998 /Zp4 default. (Console.uc's vtblOut int only covers 4 bytes of the
// 8-byte FOutputDevice vfptr; LinkOffsets biases the script layout by +4.)
#pragma pack (push,4)
