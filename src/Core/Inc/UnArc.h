...
public:
	...
	// x64 port note: the original UBOOL overload was removed — UBOOL and INT
	// are the same type (signed int), which modern compilers reject as a
	// duplicate definition. The INT overload below covers UBOOL.
